...
export default function TrollslandeApp() {
  ...
  const allSpecies = [
    "Aftonfalk", "Alfågel", "Alförrädare", "Alkekung", "Alpjärnsparv",
    "Alpseglare", "Amerikansk beckasin", "Amerikansk bläsand", "Amerikansk knölsvärta", "Amerikansk kopparand",
    "Amerikansk rördrom", "Amerikansk sjöorre", "Amerikansk skogssnäppa", "Amerikansk tundrapipare", "Amurfalk",
    "Asiatisk kalanderlärka", "Azurmes", "Backsvala", "Balkansångare", "Beigekindad skogstrast",
    "Bergand", "Bergfink", "Berglärka", "Bergortolan", "Bergsångare",
    "Bergtajgasångare", "Berguv", "Beringvarfågel", "Beringärla", "Bivråk",
    "Biätare", "Björktrast", "Blek tornseglare", "Blå kärrhök", "Blåhake",
    "Blåkråka", "Blåmes", "Blåtrast", "Blåvingad årta", "Bläsand",
    "Bläsgås", "Bofink", "Brandkronad kungsfågel", "Brednäbbad simsnäppa", "Bredstjärtad labb",
    "Brokig kardinal", "Bronsibis", "Brun glada", "Brun kärrhök", "Brun törnskata",
    "Brunand", "Brunsångare", "Bruntrast", "Brushane", "Buskskvätta",
    "Busksångare", "Bändelkorsnäbb", "Citronärla", "Dalripa", "Dammsnäppa",
    "Diomedeslira", "Domherre", "Drillsnäppa", "Dubbelbeckasin", "Dubbeltrast",
    "Duvhök", "Dvärgbeckasin", "Dvärgmås", "Dvärgrördrom", "Dvärgskarv",
    "Dvärgsnäppa", "Dvärgsnögås", "Dvärgsparv", "Dvärgspov", "Dvärgsumphöna",
    "Dvärgsångare", "Dvärgsävsparv", "Dvärguv", "Dvärgörn", "Ejder",
    "Eksångare", "Eleonorafalk", "Enkelbeckasin", "Entita", "Eremitskogstrast",
    "Fasan", "Fiskgjuse", "Fiskmås", "Fisktärna", "Fjällabb",
    "Fjällgås", "Fjällpipare", "Fjällripa", "Fjälluggla", "Fjällvråk",
    "Flodsångare", "Fläckdrillsnäppa", "Forsärla", "Fältpiplärka", "Fältsångare",
    "Garfågel", "Glasögonflugsnappare", "Gluttsnäppa", "Gransångare", "Gravand",
    "Grå flugsnappare", "Grågam", "Grågås", "Gråhakedopping", "Gråhalsad trast",
    "Gråhuvad sparv", "Gråhuvad vipa", "Gråhäger", "Grålira", "Gråsiska",
    "Gråsparv", "Gråspett", "Gråtrut", "Gräsand", "Gräshoppsångare",
    "Grässångare", "Grön biätare", "Grönbena", "Grönfink", "Gröngöling",
    "Grönsiska", "Grönsångare", "Gulbrynad sparv", "Gulbröstad snäppa", "Guldtrast",
    "Gulgrå sparv", "Gulhämpling", "Gulkindad kricka", "Gulnäbbad lira", "Gulsparv",
    "Gulärla", "Gyllensparv", "Gåsgam", "Gärdsmyg", "Gök",
    "Göktyta", "Halsbandsflugsnappare", "Havssula", "Havstrut", "Havsörn",
    "Hornuggla", "Hudsonspov", "Hussvala", "Häcksparv", "Hämpling",
    "Härfågel", "Härmsångare", "Höksångare", "Hökuggla", "Hökörn",
    "Iberisk gransångare", "Isabellastenskvätta", "Isabellatörnskata", "Ismås", "Jaktfalk",
    "Jorduggla", "Jungfrutrana", "Järnsparv", "Järpe", "Kaja",
    "Kalanderlärka", "Kamtjatkapipare", "Kanadagås", "Karolinasumphöna", "Kaspisk pipare",
    "Kaspisk trut", "Kattuggla", "Kaukasisk lundsångare", "Kaveldunsångare", "Kejsarörn",
    "Kentsk tärna", "Klippkaja", "Klippsparv", "Klippsvala", "Klykstjärtad stormsvala",
    "Knipa", "Knölsvan", "Kohäger", "Koltrast", "Kolymasnäppa",
    "Kornknarr", "Kornsparv", "Korp", "Korttålärka", "Kragtrapp",
    "Kricka", "Krushuvad pelikan", "Kråka", "Kungsfiskare", "Kungsfågel",
    "Kungsfågelsångare", "Kungsörn", "Kustlabb", "Kustpipare", "Kustsnäppa",
    "Kärrsnäppa", "Kärrsångare", "Kärrtärna", "Ladusvala", "Lappmes",
    "Lappsparv", "Lappuggla", "Lavskrika", "Ljungpipare", "Lundsångare",
    "Lunnefågel", "Långnäbbad mås", "Långtåsnäppa", "Lärkfalk", "Lövsångare",
    "Macchiasångare", "Mandarinand", "Masktörnskata", "Medelhavstrut", "Mellanspett",
    "Mindre albatross", "Mindre beckasinsnäppa", "Mindre bergand", "Mindre flugsnappare", "Mindre gulbena",
    "Mindre hackspett", "Mindre korsnäbb", "Mindre lira", "Mindre skrikörn", "Mindre strandpipare",
    "Mindre sumphöna", "Mindre sångsvan", "Minervauggla", "Mongolpiplärka", "Morkulla",
    "Mosnäppa", "Myrsnäppa", "Myrspov", "Mörkögd junco", "Natthäger",
    "Nattskärra", "Nilgås", "Nordsångare", "Nunnestenskvätta", "Näktergal",
    "Nötkråka", "Nötskrika", "Nötväcka", "Orientseglare", "Orientvadarsvala",
    "Ormvråk", "Ormörn", "Orre", "Ortolansparv", "Papegojalka",
    "Pilfink", "Pilgrimsfalk", "Piparsnäppa", "Polargås", "Polyglottsångare",
    "Praktejder", "Provencesångare", "Prutgås", "Prärielöpare", "Präriemås",
    "Präriesimsnäppa", "Prärietrana", "Pungmes", "Purpurhäger", "Pärluggla",
    "Rallhäger", "Rapphöna", "Ringand", "Ringduva", "Ringnäbbad mås",
    "Ringtrast", "Rosenfink", "Rosenmås", "Rosenstare", "Rosensångare",
    "Rosentärna", "Roskarl", "Rostand", "Rostgumpad törnskata", "Rostgumpsvala",
    "Rostskogstrast", "Rostsparv", "Rostsångare", "Rubinnäktergal", "Råka",
    "Röd glada", "Rödbena", "Rödfalk", "Rödhake", "Rödhalsad gås",
    "Rödhalsad snäppa", "Rödhuvad dykand", "Rödhuvad törnskata", "Rödkindad sparv", "Rödspov",
    "Rödstjärt", "Rödstrupig piplärka", "Rödstrupig sångare", "Rödtrast", "Rödvingad vadarsvala",
    "Rödvingetrast", "Rödögd vireo", "Rördrom", "Rörhöna", "Rörsångare",
    "Salskrake", "Sammetshätta", "Sandlöpare", "Sandsnäppa", "Sandtärna",
    "Saxaulsångare", "Sibirisk gråsnäppa", "Sibirisk järnsparv", "Sibirisk knölsvärta", "Sibirisk lundsångare",
    "Sibirisk piplärka", "Sibirisk trast", "Sibirisk tundrapipare", "Sidensvans", "Silkeshäger",
    "Sillgrissla", "Silltrut", "Silvertärna", "Sjöorre", "Skata",
    "Skatgök", "Skedand", "Skedstork", "Skogsduva", "Skogsgås",
    "Skogssnäppa", "Skorstenseglare", "Skrattmås", "Skräntärna", "Skäggdopping",
    "Skäggmes", "Skäggtärna", "Skärfläcka", "Skärpiplärka", "Skärsnäppa",
    "Slaguggla", "Smalnäbbad simsnäppa", "Smutsgam", "Smådopping", "Småfläckig sumphöna",
    "Smålom", "Småskrake", "Småsnäppa", "Småspov", "Småtrapp",
    "Småtärna", "Snatterand", "Snösparv", "Sommargylling", "Sothöna",
    "Sottärna", "Sotvingad mås", "Spansk sparv", "Sparvhök", "Sparvuggla",
    "Spetsbergsgrissla", "Spetsbergsgås", "Spetsstjärtad duva", "Spetsstjärtad snäppa", "Spillkråka",
    "Spovsnäppa", "Stare", "Starrsångare", "Steglits", "Stenfalk",
    "Stenknäck", "Stenpiplärka", "Stenskvätta", "Stensvala", "Stentrast",
    "Stillahavslom", "Stjärtand", "Stjärtmes", "Storlabb", "Storlom",
    "Stormfågel", "Stormsvala", "Storskarv", "Storskrake", "Storspov",
    "Stortrapp", "Strandskata", "Stripgås", "Strömand", "Strömstare",
    "Stubbstjärtseglare", "Styltlöpare", "Styltsnäppa", "Stäppflyghöna", "Stäpphök",
    "Stäppsångare", "Stäppvipa", "Stäppörn", "Större beckasinsnäppa", "Större gulbena",
    "Större hackspett", "Större korsnäbb", "Större lira", "Större piplärka", "Större skrikörn",
    "Större strandpipare", "Större turturduva", "Sumpcettia", "Sumpvipa", "Svart buskskvätta",
    "Svart rödstjärt", "Svart stork", "Svartand", "Svartbent strandpipare", "Svartbrynad albatross",
    "Svarthakad buskskvätta", "Svarthakedopping", "Svarthalsad dopping", "Svarthalsad trast", "Svarthuvad mås",
    "Svarthuvad sparv", "Svarthuvad trut", "Svarthätta", "Svartlärka", "Svartmes",
    "Svartnäbbad islom", "Svartpannad törnskata", "Svartsnäppa", "Svartstrupig järnsparv", "Svarttärna",
    "Svartvingad glada", "Svartvingad vadarsvala", "Svartvit flugsnappare", "Svärta", "Sydnäktergal",
    "Sånglärka", "Sångsparv", "Sångsvan", "Sädesärla", "Sävsparv",
    "Sävsångare", "Taggstjärtseglare", "Tajgablåstjärt", "Tajgaflugsnappare", "Tajgasångare",
    "Talgoxe", "Tallbit", "Tallsparv", "Talltita", "Taltrast",
    "Tempelsvala", "Tereksnäppa", "Tibetpipare", "Tjockfot", "Tjäder",
    "Tobisgrissla", "Tofslunne", "Tofslärka", "Tofsmes", "Tofsvipa",
    "Toppskarv", "Tordmule", "Tornfalk", "Tornseglare", "Tornuggla",
    "Trana", "Trastsångare", "Tretåig hackspett", "Tretåig mås", "Trädgårdssångare",
    "Trädgårdsträdkrypare", "Trädkrypare", "Trädlärka", "Trädmås", "Trädpiplärka",
    "Träsksångare", "Tundragås", "Tundrapiplärka", "Tundrasnäppa", "Tundrasparv",
    "Turkduva", "Turkestantörnskata", "Turturduva", "Tuvsnäppa", "Tygeltärna",
    "Tärnmås", "Törnskata", "Törnsångare", "Vaktel", "Vandringstrast",
    "Varfågel", "Vassångare", "Vattenpiplärka", "Vattenrall", "Vattensångare",
    "Videsparv", "Videsångare", "Vigg", "Vinterhämpling", "Vit stork",
    "Vitgumpad buskskvätta", "Vitgumpseglare", "Vitgumpsnäppa", "Vitkindad gås", "Vitnackad svärta",
    "Vitnäbbad islom", "Vitryggig hackspett", "Vitstrupig näktergal", "Vitstrupig sparv", "Vittrut",
    "Vitvingad lärka", "Vitvingad trut", "Vitvingad tärna", "Vitögd dykand", "Västlig medelhavsstenskvätta",
    "Årta", "Ägretthäger", "Ängshök", "Ängspiplärka", "Ärtsångare",
    "Ökenlöpare", "Ökennattskärra", "Ökenpipare", "Ökenstenskvätta", "Ökensångare",
    "Ökentrumpetare", "Örnvråk", "Östlig kronsångare", "Östlig medelhavsstenskvätta"
  ...
  const exportToExcel = (rowsArg = results, modeArg = viewMode) => {
    ...
    const filename = `faglar_${selectedSpecies.replaceAll(" ", "_").replaceAll("--", "")}_${fromYear}${month ? `_${month}` : ""}.xlsx`;
  ...
  const exportToPdf = async () => {
    ...
    try {
      ...
      const filename = `faglar_${currentViewModeRef.current}_${selectedSpecies.replaceAll(" ", "_").replaceAll("--", "")}_${fromYear}${month ? `_${month}` : ""}.pdf`;
      pdf.save(filename);
